<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center space-x-3">
            ...
            <div>
                <h1 class="text-2xl font-bold text-slate-900 tracking-tight">Créer une campagne marketing</h1>
                <p class="text-sm text-slate-500 mt-1">Ajouter une nouvelle campagne d'acquisition et définir ses objectifs.</p>
            </div>
        </div>
    </x-slot>

    <div class="max-w-4xl mx-auto">
        <form method="POST" action="{{ route('campagnes.store') }}" class="space-y-6">
            @csrf
            ...
            <div class="bg-white rounded-2xl border border-slate-100 shadow-sm p-6 space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <x-text-input id="nom" class="block mt-1 w-full rounded-xl border-slate-200 focus:border-indigo-500 focus:ring-indigo-500" type="text" name="nom" :value="old('nom')" required autofocus placeholder="Ex: Campagne Printemps 2026..." />
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea id="description" name="description" rows="3" class="block mt-1 w-full rounded-xl border-slate-200 focus:border-indigo-500 focus:ring-indigo-500 text-sm shadow-sm" placeholder="Objectifs de la campagne, cibles visées...">{{ old('description') }}</textarea>
            ...
            <div class="bg-white rounded-2xl border border-slate-100 shadow-sm p-6 space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <x-text-input id="budget" class="block mt-1 w-full rounded-xl border-slate-200 focus:border-indigo-500 focus:ring-indigo-500" type="number" step="0.01" name="budget" :value="old('budget')" placeholder="Ex: 5000" />
                    ...
                    <div>
                        ...
                        <x-text-input id="date_debut" class="block mt-1 w-full rounded-xl border-slate-200 focus:border-indigo-500 focus:ring-indigo-500" type="date" name="date_debut" :value="old('date_debut')" />
                    ...
                    <div>
                        ...
                        <x-text-input id="date_fin" class="block mt-1 w-full rounded-xl border-slate-200 focus:border-indigo-500 focus:ring-indigo-500" type="date" name="date_fin" :value="old('date_fin')" />

    ...
    <div id="importModal" class="hidden fixed inset-0 z-50 flex items-center justify-center bg-slate-900/50 backdrop-blur-sm">
        <div class="bg-white rounded-2xl shadow-xl w-full max-w-md overflow-hidden">
            ...
            <form action="{{ route('prospects.import') }}" method="POST" enctype="multipart/form-data" class="p-6">
                ...
                <div class="mb-4">
                    <label for="import_source_id" class="block text-xs font-semibold text-slate-700 mb-2">Source par défaut (Optionnelle)</label>
                    <select name="source_id" id="import_source_id" class="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-2 text-xs text-slate-700 focus:outline-none focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 transition-all">
                        <option value="">Aucune source par défaut</option>
                ...
                <div class="mb-6">
                    <label for="import_campagne_id" class="block text-xs font-semibold text-slate-700 mb-2">Campagne par défaut (Optionnelle)</label>
                    <select name="campagne_id" id="import_campagne_id" class="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-2 text-xs text-slate-700 focus:outline-none focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 transition-all">
                        <option value="">Aucune campagne par défaut</option>

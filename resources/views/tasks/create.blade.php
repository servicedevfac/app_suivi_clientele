<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center space-x-3">
            ...
            <div>
                <h1 class="text-2xl font-bold text-slate-900 tracking-tight">Créer une tâche</h1>
                <p class="text-sm text-slate-500 mt-1">Ajouter une nouvelle tâche commerciale et l'assigner à un collaborateur.</p>
            </div>
        </div>
    </x-slot>
            ...
            <div class="bg-white rounded-2xl border border-slate-100 shadow-sm p-6 space-y-6">
                ...
                <div class="grid grid-cols-1 gap-6">
                    ...
                    <div>
                        ...
                        <x-text-input id="titre" class="block mt-1 w-full rounded-xl border-slate-200 focus:border-indigo-500 focus:ring-indigo-500" type="text" name="titre" :value="old('titre')" required placeholder="Ex: Relancer le prospect Dupont après envoi devis" />
                    ...
                    <div>
                        ...
                        <textarea id="description" name="description" rows="4" class="block mt-1 w-full rounded-xl border-slate-200 focus:border-indigo-500 focus:ring-indigo-500 text-sm shadow-sm" placeholder="Ajoutez des détails sur la tâche à réaliser...">{{ old('description') }}</textarea>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <select id="statut" name="statut" required class="block mt-1 w-full rounded-xl border-slate-200 focus:border-indigo-500 focus:ring-indigo-500 text-sm shadow-sm">
                            <option value="À faire" {{ old('statut', 'À faire') === 'À faire' ? 'selected' : '' }}>À faire</option>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <x-text-input id="date_limite" class="block mt-1 w-full rounded-xl border-slate-200 focus:border-indigo-500 focus:ring-indigo-500" type="datetime-local" name="date_limite" :value="old('date_limite')" />
